  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sector" do
        ...
        Sector.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => sector.to_param, :sector => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sector as @sector" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sector.any_instance.stub(:save).and_return(false)
        put :update, {:id => sector.to_param, :sector => { "name" => "invalid value" }}, valid_session
        assigns(:sector).should eq(sector)
      end
